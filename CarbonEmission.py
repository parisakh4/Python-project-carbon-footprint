...
def main():
        ...
        if electricity.strip() and gass.strip() and fuel.strip():
            try:
                ...
                if carbon_footprint.energy_emission > energy_benchmark:
                    ...
                    with st.expander("See recomendations for Improvements."):
                        st.write("""Recommendations for reducing carbon emissions from energy usage in commercial buildings:<br><br> 
        ...
        if waste_generate.strip() and waste_recycle.strip():
            try:
                ...
                if carbon_footprint.waste_emission > waste_benchmark:
                        ...
                        with st.expander("See Recommendations for Improvement"):
                            st.write(
                                    """Recommendations for Reducing Waste Emissions in Commercial Buildings To effectively reduce waste emissions in commercial buildings, the following inclusive recommendations are proposed:<br><br>
                                    ...
                                    **Monitor and Evaluate:**<br>
                                    ...
                                    By implementing these recommendations, commercial buildings can significantly reduce waste emissions, improve environmental quality, and promote sustainable business practices. Source:[Waste Manageent](https://www.sciencedirect.com/science/article/pii/S0956053X10002229?casa_token=4cmTS-biZmoAAAAA:jo_geg3FXEVFtM9NB3Sw__ay1SmBxeA8uoRFBvnWD-crXpu-1G0a1OcQpNCGgdEB2FhaJCGQdGg)""", unsafe_allow_html=True)
                else:
        ...
        if travel_km.strip() and fuel_efficiency.strip():
            try:
                ...
                if carbon_footprint.travel_emission > travel_benchmark:
                    ...
                    with st.expander("See recommendations for improvement"):
                        st.write("""Recommendations for reducing carbon emissions from business travels:<br><br>
                                ...
                                **Support Work-Life Balance:**<br>
                                ...
                                By implementing these recommendations, organizations can effectively reduce carbon emissions from business travel while maintaining productivity and meeting business objectives. Source: [Transportation Research Part A: Policy and Practice](https://www.sciencedirect.com/science/article/pii/S096585641400202X?casa_token=I8YVgZJoUh4AAAAA:3Gy5FpCCnQA5fiJr9KODugw7n-MxPESsu_31tT5dDq6onkoewG9xNh4yPxtZ4bC4h0szEOKbKBU) ​ """, unsafe_allow_html=True)
                else:
    ...
    if not all_reports.empty:
        ...
        st.plotly_chart(
        plot_colored_bar_chart(all_reports, st.session_state["active_client_id"], 
